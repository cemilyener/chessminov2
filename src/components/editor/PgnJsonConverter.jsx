// filepath: c:\Users\PC\Desktop\chessminov2\src\components\editor\PgnJsonConverter.jsx
import React, { useState, useRef } from 'react';
import useChessStore from '../../store/useChessStore';

/**
 * PgnJsonConverter - PGN dosyalarını ve metinlerini JSON formatına dönüştürmek için bileşen
 * ChessBase formatındaki PGN dosyalarını işleyip standart JSON çıktısı üretir
 */
const PgnJsonConverter = () => {
  const { 
    loadPgnFile, 
    loadPgnText, 
    exportAsFile,
...
export default PgnJsonConverter;